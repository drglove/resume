...
%   Excellence in Animation \hfill 2008
    ...
    %\textbf{Dr. Bob Smith}                   &  \textbf{Dr. Bob Smith}                            \\
    %Professor of Bob                         &  Assistant of Bob                                  \\
    %Bob Observatory                          &  Bob Observatory                                   \\
    %Hilo, HI, US                             &  Hilo, HI, US                                      \\
    %phone: \textsl{+1 (xxx) abc-1234}        &                                                    \\
    %e-mail: \textsl{bobsmith@bobsmith.edu}   &  e-mail: \textsl{bobsmith@bobsmith.edu}            \\
    %\end{tabular}

    %\begin{tabular}{@{}p{6cm}p{6cm}}
    %Repeat as above as necessary
    %\end{tabular}
